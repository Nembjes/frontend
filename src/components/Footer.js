                    ...
                    <div className="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                       <div className="single-wedge">
                          ...
                          <p className="about-text">
                             Lorem ipsum dolor sit amet consl adipisi elit, sed
                             do eiusmod templ incididunt ut labore
                          </p>
                    ...
                    <div className="row flex-md-row-reverse align-items-center">
                       <div className="col-md-8 text-center text-md-start">
                          <p className="copy-text">
                             © 2023-2024 <strong>Elshop</strong> Made with{' '}
